...
page_number <- dlgInput("Insert the number of page of questions that you would like to scrape", Sys.info()["Page Number"])$res
...
purrr::map_df(page_numbers, ~ { 
  ...
  url_reviews <- paste0("https://www.amazon.it/ask/questions/asin/",prod_code,"/",.x,"/ref=ask_ql_psf_ql_hza?isAnswered=true")
